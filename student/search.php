...
include '../config.php';
session_start(); 
if(!$_SESSION['student'] && !$_SESSION['sname']){ 
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['sname']; ?></span>
...
<tr>
  ...
  <p style="margin: 0"><a target="_blank" href="<?php echo "../faculty/uploads/".$row['filename']; ?>"><?php echo $row['filename']; ?> </a></p>
