...
<body class="bg-gradient-primary">
            ...
            <div class="p-5">
              ...
              <form class="user" method="post">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" placeholder="Registration number" name="username">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password" name="cpass">
                  </div>
                </div>
  ...
  <?php
  include 'config.php';
  if(isset($_POST['register']) && $_POST['pass']==$_POST['cpass']){
    $sql = "INSERT INTO `student`(`username`, `fname`, `lname`, `password`) VALUES ('".$_POST['username']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['pass']."')";
