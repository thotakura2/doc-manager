...
include '../config.php';
session_start(); 
if(!$_SESSION['faculty'] && !$_SESSION['fname']){ 
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="add_doc.php">
          <i class="fa fa-plus"></i>
          <span>Upload New Document</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="search.php">
          <i class="fa fa-search"></i>
          <span>Search Document</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="man_doc.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Manage your documents.</h1>
          
          <table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            <thead><tr><th class="th-sm">S. No.</th>
              <th class="th-sm">Tags</th>
              <th class="th-sm">Document</th>
              <th class="th-sm">Actions</th></tr></thead><tbody>
              <?php
              $sql="select * from files where owner='".$_SESSION['faculty']."'";
              ...
              <tr>
                ...
                <td><button name="edit" onclick="location.href = 'action.php?edit=&id='+'<?php echo $row['id']; ?>';"  class="btn"><i class="fa fa-edit"></i></button><button  name="delete" class="btn" onclick="location.href = 'action.php?delete=&id='+'<?php echo $row['id']; ?>';"><i class="fa fa-trash"></i></button></td>
              </tr>
              <?php
              }
              ?>
