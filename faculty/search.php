    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Search for ducuments based on tags.</h1>
          <form  method="post"> 
  <div class="row">
    <div class="col-xs-6 col-md-4">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="Enter tag to search" name="search">
...
if (isset($_POST['submit'])) {
  if ($_POST['search']!="") {
    $sql = "Select * from files where tags like '%".$_POST['search']."%'";
...
<tr>
  <td><?php echo ++$sno; ?></td>
  <td><p style="margin: 0"><?php echo "Owner: ".$row['owner'];?></p>
    
  <p style="margin: 0"><a target="_blank" href="<?php echo "uploads/".$row['filename']; ?>"><?php echo $row['filename']; ?> </a></p>
<p style="margin: 0"><?php echo "\n Upload time: ".$row['time']; ?></p></td>
</tr>
<?php
    }
  }
