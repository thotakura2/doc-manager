    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Upload your Document</h1>
          <form method="post" enctype="multipart/form-data">
<input type="file" name="fileToUpload" id="files" multiple="" onChange="makeFileList();" accept=
"application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
text/plain, application/pdf" /><br><br>
<input type="text" name="search_tags" placeholder="enter search tags"><br><br>
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
      $sql = "INSERT INTO `files`(`owner`, `tags`, `filename`, `time`) VALUES ('".$_SESSION['faculty']."','".$_POST['search_tags']."','".basename( $_FILES["fileToUpload"]["name"])."', now())";
      mysqli_query($db,$sql);
