          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="change_password.php" data-toggle="modal" data-target="#logoutModal">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Docs uploaded (This Month)</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php 
                      $sql = "select * from files where time between  DATE_FORMAT(CURDATE() ,'%Y-%m-01') AND CURDATE()";
                      include '../config.php';
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total docs uploaded</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php 
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total active students</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php 
