      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <table class="table table-striped">
            ...
            $que = "select * from student where username like '%".$_POST['sear']."%'";
            ...
            while ($row = mysqli_fetch_array($res)) {
             ...
             <tr>
               ...
               <td><form mwthod= "post"><input type="hidden" name="username" value="<?php echo $row['username']; ?>"><input class="btn btn-primary" type="submit" name="activate" value="activate"></form></td>
             </tr>
             <?php
            }
          }
            ...
            if(isset($_POST['activate'])){
              $que = "UPDATE `student` SET `status`=1 WHERE username = '".$_POST['username']."'";
              if (mysqli_query($db,$que)) {
                echo "<script>alert('succesfully activated user');</script>";
              }
            }?>
          </table>
          </form>
