...
<li class="nav-item active">
      ...
      <li class="nav-item">
        <a class="nav-link" href="act_student.php">
          <i class="fa fa-address-book"></i>
          <span>Activate student</span></a>
      </li>
        ...
        <div class="container-fluid">
            ...
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Add new Faculty!</h1>
              </div>
              <form class="user" method="post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" name="fname" class="form-control form-control-user"  placeholder="First Name" id="fname">
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="lname"  class="form-control form-control-user" placeholder="Last Name" id="lname">
                  </div>
                </div>
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-user"  placeholder="Email Address" id="email">
                </div>
                <div class="form-group">
                  <select class="form-control" id="dept">
                    ...
                    ?>
                    <option value="<?php echo $row['sno']; ?>"><?php echo $row['course_name']; ?></option>
                    <?php
                  }
                  ?>
                  </select>
                ...
                <input type="button" name="register" value="Register Faculty" class="btn btn-primary btn-user btn-block" id="reg_btn">
