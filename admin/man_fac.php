      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <table class="table table-hover">
            ...
            $res = mysqli_query($db,"select * from dept where sno='".$row['department']."'");
            ...
            <tr>
              ...
              <td><button class="btn btn-primary" onclick="location.href = 'cuser.php?username=<?php echo $row['username']; ?>';">Delete</button></td>
            </tr>
            <?php
          }
            ?>
